...
1.创建SqlSessionFacotryBuilder对象，调用build(inputStream)方法读取并解析配置文件，返回SqlSessionFactory对象。

2.由SqlSessionFactory创建Sqlsession对象，没有手动配置的话事务默认开启
...
![1.jgp](https://img-blog.csdn.net/20140718132806515)
