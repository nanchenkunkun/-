...
但是，有很多人却误认为Java中的对象传递是引用传递。之所以会有这个误区，主要是因为Java中的变量和对象之间是有引用关系的。Java语言中是通过对象的引用来操纵对象的。所以，很多人会认为对象的传递是引用的传递。<br />而且很多人还可以举出以下的代码示例：
...
所以，很多人说，这和引用传递的现象是一样的，就是在方法内改变参数的值，会影响到调用方。<br />但是，其实这是走进了一个误区。
...
我们先回到上面的例子中来，看一下调用过程中实际上发生了什么？<br />![](https://cdn.nlark.com/yuque/0/2023/png/5378072/1690711567770-03fe147a-9948-4fe2-ad99-299e8a610f70.png#averageHue=%23faf3ec&clientId=ufe7ad34b-c0bc-4&from=paste&id=u4f328233&originHeight=732&originWidth=832&originalType=url&ratio=1&rotation=0&showTitle=false&status=done&style=none&taskId=u8ca9f0ff-8fe1-495d-8b37-2602ca6d558&title=)<br />在参数传递的过程中，实际参数的地址`0X1213456`被拷贝给了形参。这个过程其实就是值传递，只不过传递的值得内容是对象的引用。
...
![](https://cdn.nlark.com/yuque/0/2023/png/5378072/1690711567783-5ce8c5bb-52aa-4774-836f-ac51db0cb68a.png#averageHue=%23faf4ee&clientId=ufe7ad34b-c0bc-4&from=paste&id=u8cf2e9db&originHeight=721&originWidth=859&originalType=url&ratio=1&rotation=0&showTitle=false&status=done&style=none&taskId=udf700f3e-bf07-461d-aee6-7f37c30d9ac&title=)<br />这个过程，就好像你复制了一把钥匙给到你的朋友，你的朋友拿到你给他的钥匙之后，找个锁匠把他修改了一下，他手里的那把钥匙变成了开他家锁的钥匙。这时候，他打开自己家，就算是把房子点了，对你手里的钥匙，和你家的房子来说都是没有任何影响的。
